"""Configuración central del pipeline RAG industrial multi-máquina."""
...
class Settings(BaseSettings):
    ...
    # Opcional: solo se usa en la CONSULTA, nunca en la ingestión de PDFs.
    ...
    manuals_path: Path = Path("data/manuals")
