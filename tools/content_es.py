...
def nav():
    return """
      ...
      <a href="descargas/KK-5S-Manual-Operacion-ES.pdf">Descargar PDF</a>
...
"""
    ...
    index = """
      ...
      <h2>Descargas</h2>
      <p>Copias para llevar sin servidor. El PDF incluye el manual completo con capturas de pantalla.</p>
      <div class="cards">
        <a class="card" href="descargas/KK-5S-Manual-Operacion-ES.pdf" download>
          <div class="num">PDF</div>
          <h3>Manual en español</h3>
          <p>Archivo único para imprimir, WhatsApp o USB de taller.</p>
        </a>
        <a class="card" href="descargas/KK-5S-User-Manual-EN.pdf" download>
          <div class="num">PDF</div>
          <h3>Manual in English</h3>
        ...
        <a class="card" href="descargas/KK-5S-manual-offline.zip" download>
          ...
          <h3>Sitio web offline</h3>
          <p>HTML + imágenes. Abra <code>index.html</code> en cualquier navegador.</p>
        </a>
        <a class="card" href="original/Cold_Cutting_Flying_Saw_Instruction_Manual.docx" download>
          <div class="num">DOCX</div>
          <h3>Word original</h3>
          <p>Manual de fábrica (inglés), mayo 2019 V1.36.</p>
        </a>
      </div>
      <h2>Vocabulario de la pantalla (HMI)</h2>
      <p>Las capturas y los nombres de botones se dejan en inglés, tal como aparecen en la máquina. Equivalencias usadas en este manual:</p>
